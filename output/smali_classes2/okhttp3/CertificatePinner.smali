...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/CertificatePinner$Companion;-><init>(Lgm7;)V
...
.method public synthetic constructor <init>(Ljava/util/Set;Lokhttp3/internal/tls/CertificateChainCleaner;ILgm7;)V
    .locals 0
...
.method public static final sha1Hash(Ljava/security/cert/X509Certificate;)Lbt7;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Lbt7;
...
.method public static final sha256Hash(Ljava/security/cert/X509Certificate;)Lbt7;
    .locals 1

    sget-object v0, Lokhttp3/CertificatePinner;->Companion:Lokhttp3/CertificatePinner$Companion;

    invoke-virtual {v0, p0}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Lbt7;
...
.method public final check(Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {p0, p1, v0}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lel7;)V
...
.method public final varargs check(Ljava/lang/String;[Ljava/security/cert/Certificate;)V
    ...
    .line 2
    invoke-static {p2}, Ln56;->v2([Ljava/lang/Object;)Ljava/util/List;
...
.method public final check$okhttp(Ljava/lang/String;Lel7;)V
    .locals 10
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v5, v2}, Lokhttp3/CertificatePinner$Companion;->sha1Hash(Ljava/security/cert/X509Certificate;)Lbt7;

    move-result-object v5

    .line 9
    :cond_3
    invoke-virtual {v6}, Lokhttp3/CertificatePinner$Pin;->getHash()Lbt7;
    ...
    invoke-virtual {v4, v2}, Lokhttp3/CertificatePinner$Companion;->sha256Hash(Ljava/security/cert/X509Certificate;)Lbt7;
    ...
    invoke-static {v6, v4}, Lim7;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method public final findMatchingPins(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 7
    :cond_1
    invoke-static {v1}, Lvm7;->a(Ljava/lang/Object;)Ljava/util/List;
