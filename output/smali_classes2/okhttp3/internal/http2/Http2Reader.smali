...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Lgm7;)V
...
.method public constructor <init>(Lat7;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lat7;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lvt7;IIILgm7;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
    ...
    .line 3
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILat7;I)V

    .line 4
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
    ...
    .line 2
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
    ...
    invoke-interface {v0, v1, v2}, Lat7;->s(J)Lbt7;

    move-result-object v0

    .line 6
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lbt7;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 1
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 5
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p3, p2, p4}, Ljo;->h(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 5
    invoke-static {v0, p2}, Len7;->d(II)Ldn7;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Len7;->c(Lbn7;I)Lbn7;
    ...
    invoke-interface {v3}, Lat7;->readShort()S
    ...
    .line 10
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lat7;

    invoke-interface {v4}, Lat7;->readInt()I
    ...
    invoke-static {p2, v4}, Ljo;->g(Ljava/lang/String;I)Ljava/lang/String;
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, Lat7;->D0(J)V
    :try_end_0
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lat7;)I
    ...
    invoke-interface {p1, v0, v1}, Lat7;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lbt7;
    ...
    .line 6
    invoke-interface {p1, v2, v3}, Lat7;->s(J)Lbt7;
    ...
    invoke-virtual {p1}, Lbt7;->O()Ljava/lang/String;
