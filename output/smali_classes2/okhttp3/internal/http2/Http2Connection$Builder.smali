...
.field public sink:Lzs7;

.field public socket:Ljava/net/Socket;

.field public source:Lat7;
...
.method public static synthetic socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lat7;Lzs7;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 0
    ...
    .line 2
    invoke-static {p1}, Ln56;->f2(Ljava/net/Socket;)Lvt7;

    move-result-object p3

    invoke-static {p3}, Ln56;->p(Lvt7;)Lat7;
    ...
    .line 3
    invoke-static {p1}, Ln56;->b2(Ljava/net/Socket;)Ltt7;

    move-result-object p4

    invoke-static {p4}, Ln56;->o(Ltt7;)Lzs7;

    move-result-object p4

    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lat7;Lzs7;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final getSink$okhttp()Lzs7;
    .locals 1

    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lzs7;
...
.method public final getSource$okhttp()Lat7;
    .locals 1

    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lat7;
...
.method public final setSink$okhttp(Lzs7;)V
    .locals 1
    ...
    .line 1
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lzs7;
...
.method public final setSource$okhttp(Lat7;)V
    .locals 1
    ...
    .line 1
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lat7;
...
.method public final socket(Ljava/net/Socket;)Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    invoke-static/range {v0 .. v6}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lat7;Lzs7;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lat7;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lat7;Lzs7;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 5
    iput-object p3, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lat7;

    .line 6
    iput-object p4, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lzs7;
