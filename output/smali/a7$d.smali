...
.method public constructor <init>()V
    ...
    .line 5
    iput v0, p0, La7$d;->d:F

    const/high16 v0, 0x7fc00000    # Float.NaN

    .line 6
    iput v0, p0, La7$d;->e:F
...
# virtual methods
.method public a(La7$d;)V
    .locals 1

    .line 1
    iget-boolean v0, p1, La7$d;->a:Z

    iput-boolean v0, p0, La7$d;->a:Z

    .line 2
    iget v0, p1, La7$d;->b:I

    iput v0, p0, La7$d;->b:I

    .line 3
    iget v0, p1, La7$d;->d:F

    iput v0, p0, La7$d;->d:F

    .line 4
    iget v0, p1, La7$d;->e:F
...
.method public b(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 6
    iget v2, p0, La7$d;->d:F

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v1

    iput v1, p0, La7$d;->d:F
    ...
    .line 8
    iget v2, p0, La7$d;->b:I

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, La7$d;->b:I

    .line 9
    sget-object v2, La7;->d:[I
    ...
    .line 11
    iget v2, p0, La7$d;->c:I

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, La7$d;->c:I
    ...
    .line 13
    iget v2, p0, La7$d;->e:F

    invoke-virtual {p1, v1, v2}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result v1

    iput v1, p0, La7$d;->e:F
