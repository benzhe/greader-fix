...
.method public constructor <init>(Landroidx/media/MediaBrowserServiceCompat$h;Landroidx/media/MediaBrowserServiceCompat$i;Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;)V
    ...
    .line 1
    iput-object p1, p0, Lne;->i:Landroidx/media/MediaBrowserServiceCompat$h;

    iput-object p2, p0, Lne;->e:Landroidx/media/MediaBrowserServiceCompat$i;

    iput-object p3, p0, Lne;->f:Ljava/lang/String;

    iput-object p4, p0, Lne;->g:Landroid/os/Bundle;

    iput-object p5, p0, Lne;->h:Landroid/support/v4/os/ResultReceiver;
...
.method public run()V
    ...
    .line 1
    iget-object v0, p0, Lne;->e:Landroidx/media/MediaBrowserServiceCompat$i;
    ...
    .line 2
    iget-object v1, p0, Lne;->i:Landroidx/media/MediaBrowserServiceCompat$h;
    ...
    iget-object v1, p0, Lne;->f:Ljava/lang/String;
    ...
    .line 4
    :cond_0
    iget-object v0, p0, Lne;->i:Landroidx/media/MediaBrowserServiceCompat$h;

    iget-object v0, v0, Landroidx/media/MediaBrowserServiceCompat$h;->a:Landroidx/media/MediaBrowserServiceCompat;

    iget-object v1, p0, Lne;->f:Ljava/lang/String;

    iget-object v2, p0, Lne;->h:Landroid/support/v4/os/ResultReceiver;

    .line 5
    new-instance v3, Lee;

    invoke-direct {v3, v0, v1, v2}, Lee;-><init>(Landroidx/media/MediaBrowserServiceCompat;Ljava/lang/Object;Landroid/support/v4/os/ResultReceiver;)V

    .line 6
    invoke-virtual {v0, v3}, Landroidx/media/MediaBrowserServiceCompat;->f(Landroidx/media/MediaBrowserServiceCompat$g;)V

    .line 7
    invoke-virtual {v3}, Landroidx/media/MediaBrowserServiceCompat$g;->a()Z
