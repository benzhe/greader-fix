...
.method public b()Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v1, v0}, Llb6;-><init>(Ljava/lang/String;)V
...
.method public fetch(Ljava/net/HttpURLConnection;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Ljava/util/Date;)Ldc6$a;
    .locals 6
    ...
    invoke-direct {p1, p7, v0, v2, v2}, Ldc6$a;-><init>(Ljava/util/Date;ILyb6;Ljava/lang/String;)V
    ...
    :cond_2
    :try_start_4
    sget-object p1, Lyb6;->f:Ljava/util/Date;
    ...
    .line 32
    sget-object p4, Lyb6;->f:Ljava/util/Date;
    ...
    :cond_5
    :try_start_b
    new-instance p3, Lyb6;

    .line 42
    invoke-direct {p3, p1, p7, p4, p5}, Lyb6;-><init>(Lorg/json/JSONObject;Ljava/util/Date;Lorg/json/JSONArray;Lorg/json/JSONObject;)V
    :try_end_b
    ...
    .line 44
    iget-object p4, p3, Lyb6;->c:Ljava/util/Date;

    .line 45
    invoke-direct {p1, p4, v1, p3, p2}, Ldc6$a;-><init>(Ljava/util/Date;ILyb6;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p3, p1}, Lkb6;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p3, p2, p4}, Lnb6;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p3, p4, p2}, Lkb6;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
