...
public final class ConnectionSpec {
    ...
    public static final class Builder {
        ...
        public final Builder cipherSuites(CipherSuite... cipherSuiteArr) {
            im7.e(cipherSuiteArr, "cipherSuites");
            if (!this.tls) {
                throw new IllegalArgumentException("no cipher suites for cleartext connections".toString());
            }
        ...
        public final Builder tlsVersions(TlsVersion... tlsVersionArr) {
            im7.e(tlsVersionArr, "tlsVersions");
            if (!this.tls) {
                throw new IllegalArgumentException("no TLS versions for cleartext connections".toString());
            }
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z) throws CloneNotSupportedException {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            im7.d(enabledCipherSuites2, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            im7.d(enabledProtocols2, "sslSocket.enabledProtocols");
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, lk7.e);
        } else {
            enabledProtocols = sSLSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sSLSocket.getSupportedCipherSuites();
        im7.d(supportedCipherSuites, "supportedCipherSuites");
        int iIndexOf = Util.indexOf(supportedCipherSuites, "TLS_FALLBACK_SCSV", CipherSuite.Companion.getORDER_BY_NAME$okhttp());
        if (z && iIndexOf != -1) {
            im7.d(enabledCipherSuites, "cipherSuitesIntersection");
            String str = supportedCipherSuites[iIndexOf];
            im7.d(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        im7.d(enabledProtocols, "tlsVersionsIntersection");
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        im7.e(sSLSocket, "socket");
        if (!this.isTls) {
            return false;
        }
        String[] strArr = this.tlsVersionsAsString;
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), lk7.e)) {
            return false;
        }
    ...
    public String toString() {
        ...
        StringBuilder sbB = jo.B("ConnectionSpec(", "cipherSuites=");
        sbB.append(Objects.toString(cipherSuites(), "[all enabled]"));
        sbB.append(", ");
        sbB.append("tlsVersions=");
        sbB.append(Objects.toString(tlsVersions(), "[all enabled]"));
        sbB.append(", ");
        sbB.append("supportsTlsExtensions=");
        sbB.append(this.supportsTlsExtensions);
        sbB.append(')');
        return sbB.toString();
    }
}
