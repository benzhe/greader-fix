...
public final class CipherSuite {
    ...
    static {
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(String str, String str2) {
                ...
                for (int i = 4; i < iMin; i++) {
                    ...
                    if (cCharAt != cCharAt2) {
                        return im7.g(cCharAt, cCharAt2) < 0 ? -1 : 1;
                    }
                }
        ...
        TLS_EMPTY_RENEGOTIATION_INFO_SCSV = companion2.init("TLS_EMPTY_RENEGOTIATION_INFO_SCSV", Base64.BASELENGTH);
    ...
    public /* synthetic */ CipherSuite(String str, gm7 gm7Var) {
        this(str);
    }
}
