...
public final class JavaNetAuthenticator implements Authenticator {
    ...
    private final InetAddress connectToInetAddress(Proxy proxy, HttpUrl httpUrl, Dns dns) throws IOException {
        ...
        if (type != null && WhenMappings.$EnumSwitchMapping$0[type.ordinal()] == 1) {
            return (InetAddress) ek7.f(dns.lookup(httpUrl.host()));
        }
        ...
        im7.d(address, "(address() as InetSocketAddress).address");
        return address;
    }
    ...
    public Request authenticate(Route route, Response response) throws IOException {
        ...
        for (Challenge challenge : listChallenges) {
            if (co7.e("Basic", challenge.scheme(), true)) {
                ...
                if (passwordAuthenticationRequestPasswordAuthentication != null) {
                    ...
                    im7.d(userName, "auth.userName");
                    char[] password = passwordAuthenticationRequestPasswordAuthentication.getPassword();
                    im7.d(password, "auth.password");
    ...
    public /* synthetic */ JavaNetAuthenticator(Dns dns, int i, gm7 gm7Var) {
