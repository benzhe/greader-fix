...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> list, String str) throws SSLPeerUnverifiedException {
        ...
        im7.d(objRemoveFirst, "queue.removeFirst()");
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (arrayList.size() > 1 || (!im7.a(x509Certificate, x509CertificateFindByIssuerAndSignature))) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && im7.a(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
