...
public final class AndroidPlatform extends Platform {
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public CustomTrustRootIndex(X509TrustManager x509TrustManager, Method method) {
            ...
            im7.e(method, "findByIssuerAndSignatureMethod");
        ...
        public boolean equals(Object obj) {
            ...
            return im7.a(this.trustManager, customTrustRootIndex.trustManager) && im7.a(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod);
        }
        ...
        public String toString() {
            StringBuilder sbZ = jo.z("CustomTrustRootIndex(trustManager=");
            sbZ.append(this.trustManager);
            sbZ.append(", findByIssuerAndSignatureMethod=");
            sbZ.append(this.findByIssuerAndSignatureMethod);
            sbZ.append(")");
            return sbZ.toString();
        }
    }
    ...
    public AndroidPlatform() {
        List listM = ek7.m(StandardAndroidSocketAdapter.Companion.buildIfSupported$default(StandardAndroidSocketAdapter.Companion, null, 1, null), new DeferredSocketAdapter(AndroidSocketAdapter.Companion.getPlayProviderFactory()), new DeferredSocketAdapter(ConscryptSocketAdapter.Companion.getFactory()), new DeferredSocketAdapter(BouncyCastleSocketAdapter.Companion.getFactory()));
    ...
    public boolean isCleartextTrafficPermitted(String str) {
        ...
        im7.d(networkSecurityPolicy, "NetworkSecurityPolicy.getInstance()");
