...
public final class Huffman {
    ...
    private final void addCode(int i, int i2, int i3) {
        ...
        while (i3 > 8) {
            i3 -= 8;
            int i4 = (i2 >>> i3) & Base64.BASELENGTH;
        ...
        int i5 = 8 - i3;
        int i6 = (i2 << i5) & Base64.BASELENGTH;
        Node[] children2 = node2.getChildren();
        im7.c(children2);
        im7.e(children2, "$this$fill");
        Arrays.fill(children2, i6, (1 << i5) + i6, node);
    }

    public final void decode(at7 at7Var, long j, zs7 zs7Var) throws IOException {
        im7.e(at7Var, "source");
        im7.e(zs7Var, "sink");
        Node node = root;
        int iAnd = 0;
        ...
        for (long j2 = 0; j2 < j; j2++) {
            iAnd = (iAnd << 8) | Util.and(at7Var.readByte(), Base64.BASELENGTH);
            terminalBitCount += 8;
            while (terminalBitCount >= 8) {
                int i = terminalBitCount - 8;
                int i2 = (iAnd >>> i) & Base64.BASELENGTH;
                Node[] children = node.getChildren();
                im7.c(children);
                node = children[i2];
                im7.c(node);
                if (node.getChildren() == null) {
                    zs7Var.K(node.getSymbol());
        ...
        while (terminalBitCount > 0) {
            int i3 = (iAnd << (8 - terminalBitCount)) & Base64.BASELENGTH;
            Node[] children2 = node.getChildren();
            im7.c(children2);
            Node node2 = children2[i3];
            im7.c(node2);
            if (node2.getChildren() != null || node2.getTerminalBitCount() > terminalBitCount) {
                return;
            }
            zs7Var.K(node2.getSymbol());
            terminalBitCount -= node2.getTerminalBitCount();
            node = root;
        }
    }

    public final void encode(bt7 bt7Var, zs7 zs7Var) throws IOException {
        im7.e(bt7Var, "source");
        im7.e(zs7Var, "sink");
        int iT = bt7Var.t();
        long j = 0;
        ...
        for (int i2 = 0; i2 < iT; i2++) {
            int iAnd = Util.and(bt7Var.y(i2), Base64.BASELENGTH);
            int i3 = CODES[iAnd];
        ...
        if (i > 0) {
            zs7Var.K((int) ((j << (8 - i)) | (255 >>> i)));
        }
    }

    public final int encodedLength(bt7 bt7Var) {
        im7.e(bt7Var, "bytes");
        long j = 0;
        for (int i = 0; i < bt7Var.t(); i++) {
            j += CODE_BIT_COUNTS[Util.and(bt7Var.y(i), Base64.BASELENGTH)];
        }
        return (int) ((j + 7) >> 3);
    }
    ...
    public static final class Node {
        ...
        public Node() {
            this.children = new Node[RecyclerView.a0.FLAG_TMP_DETACHED];
            this.symbol = 0;
