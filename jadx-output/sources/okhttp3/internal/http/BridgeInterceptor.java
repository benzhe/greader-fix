...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (z && co7.e("gzip", Response.header$default(responseProceed, HttpConnection.CONTENT_ENCODING, null, 2, null), true) && HttpHeaders.promisesBody(responseProceed) && (responseBodyBody = responseProceed.body()) != null) {
            gt7 gt7Var = new gt7(responseBodyBody.source());
            ...
            builderRequest.body(new RealResponseBody(Response.header$default(responseProceed, HttpConnection.CONTENT_TYPE, null, 2, null), -1L, n56.p(gt7Var)));
        }
