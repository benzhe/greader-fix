...
public final class Utils {
    ...
    public static final class WildcardTypeImpl implements WildcardType {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                ...
                sbZ.append(Utils.typeToString(this.lowerBound));
                return sbZ.toString();
            }
            ...
            sbZ2.append(Utils.typeToString(this.upperBound));
    ...
    public static ResponseBody buffer(ResponseBody responseBody) throws IOException {
        xs7 xs7Var = new xs7();
        responseBody.source().w0(xs7Var);
        return ResponseBody.create(responseBody.contentType(), responseBody.contentLength(), xs7Var);
    }
    ...
    public static Type getParameterUpperBound(int i, ParameterizedType parameterizedType) {
        ...
        StringBuilder sbA = jo.A("Index ", i, " not in range [0,");
    ...
    public static RuntimeException parameterError(Method method, Throwable th, int i, String str, Object... objArr) {
        StringBuilder sbB = jo.B(str, " (parameter #");
        sbB.append(i + 1);
        sbB.append(")");
        return methodError(method, th, sbB.toString(), objArr);
    }
    ...
    public static RuntimeException methodError(Method method, Throwable th, String str, Object... objArr) {
        StringBuilder sbB = jo.B(String.format(str, objArr), "\n    for method ");
        sbB.append(method.getDeclaringClass().getSimpleName());
        sbB.append(".");
        sbB.append(method.getName());
        return new IllegalArgumentException(sbB.toString(), th);
    }
    ...
    public static RuntimeException parameterError(Method method, int i, String str, Object... objArr) {
        ...
        sbB.append(i + 1);
        sbB.append(")");
        return methodError(method, sbB.toString(), objArr);
    }
}
