...
public final class R$styleable {
    ...
    public static final int BottomSheetBehavior_Layout_shapeAppearance = 14;
    public static final int BottomSheetBehavior_Layout_shapeAppearanceOverlay = 15;
    public static final int BottomSheet_bs_bottomSheetStyle = 0;
    public static final int BottomSheet_bs_checkColor = 1;
    public static final int BottomSheet_bs_closeDrawable = 2;
    public static final int BottomSheet_bs_collapseListIcons = 3;
    public static final int BottomSheet_bs_dialogBackground = 4;
    public static final int BottomSheet_bs_dividerColor = 5;
    public static final int BottomSheet_bs_gridItemLayout = 6;
    public static final int BottomSheet_bs_gridItemTitleTextAppearance = 7;
    public static final int BottomSheet_bs_headerLayout = 8;
    public static final int BottomSheet_bs_listItemLayout = 9;
    public static final int BottomSheet_bs_listItemTitleTextAppearance = 10;
    public static final int BottomSheet_bs_listStyle = 11;
    public static final int BottomSheet_bs_moreDrawable = 12;
    public static final int BottomSheet_bs_moreText = 13;
    public static final int BottomSheet_bs_numColumns = 14;
    public static final int BottomSheet_bs_titleTextAppearance = 15;
    ...
    public static final int GlowPadView_handleBackground = 7;
    public static final int GlowPadView_handleDrawable = 8;
    public static final int GlowPadView_handleForeground = 9;
    public static final int GlowPadView_handleOpacity = 10;
    public static final int GlowPadView_handleSize = 11;
    public static final int GlowPadView_handleStyle = 12;
    public static final int GlowPadView_innerRadius = 13;
    public static final int GlowPadView_magneticTargets = 14;
    public static final int GlowPadView_outerRadius = 15;
    public static final int GlowPadView_outerRingDrawable = 16;
    public static final int GlowPadView_pointDrawable = 17;
    public static final int GlowPadView_snapMargin = 18;
    public static final int GlowPadView_targetBackground = 19;
    public static final int GlowPadView_targetDescriptions = 20;
    public static final int GlowPadView_targetDrawables = 21;
    public static final int GlowPadView_vibrationDuration = 22;
    ...
    public static final int[] GlowPadView = {R.attr.allowScaling, R.attr.alwaysTrackFinger, R.attr.directionDescriptions, R.attr.feedbackCount, R.attr.firstItemOffset, R.attr.glowRadius, R.attr.gravity, R.attr.handleBackground, R.attr.handleDrawable, R.attr.handleForeground, R.attr.handleOpacity, R.attr.handleSize, R.attr.handleStyle, R.attr.innerRadius, R.attr.magneticTargets, R.attr.outerRadius, R.attr.outerRingDrawable, R.attr.pointDrawable, R.attr.snapMargin, R.attr.targetBackground, R.attr.targetDescriptions, R.attr.targetDrawables, R.attr.vibrationDuration};
