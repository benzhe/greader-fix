...
public final class NativeAdView extends FrameLayout {
    ...
    public final void setMediaView(MediaView mediaView) {
        a("3010", mediaView);
        if (mediaView != null) {
            k70 k70Var = new k70(this) { // from class: mx
                ...
                public final void a(MediaContent mediaContent) {
                    ...
                    try {
                        if (mediaContent instanceof n30) {
                            nativeAdView.f.x6(((n30) mediaContent).a);
                        } else if (mediaContent == null) {
                            nativeAdView.f.x6(null);
                        } else {
                            is0.zzdz("Use MediaContent provided by NativeAd.getMediaContent");
                        }
                    } catch (RemoteException e) {
            ...
            l70 l70Var = new l70(this) { // from class: nx
                public final NativeAdView a;
                ...
                public final void a(ImageView.ScaleType scaleType) {
                    ...
                    if (scaleType != null) {
                        try {
                            nativeAdView.f.j2(new y20(scaleType));
                        } catch (RemoteException e) {
