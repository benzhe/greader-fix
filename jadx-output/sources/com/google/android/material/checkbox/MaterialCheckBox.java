...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.h == null) {
            ...
            int iZ2 = c50.Z(this, R$attr.colorSurface);
            int iZ3 = c50.Z(this, R$attr.colorOnSurface);
            iArr2[0] = c50.p0(iZ2, iZ, 1.0f);
            iArr2[1] = c50.p0(iZ2, iZ3, 0.54f);
            iArr2[2] = c50.p0(iZ2, iZ3, 0.38f);
            iArr2[3] = c50.p0(iZ2, iZ3, 0.38f);
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayD = t85.d(context2, attributeSet, R$styleable.MaterialCheckBox, i, i2, new int[0]);
        int i3 = R$styleable.MaterialCheckBox_buttonTint;
        if (typedArrayD.hasValue(i3)) {
            setButtonTintList(c50.a0(context2, typedArrayD, i3));
        }
        this.i = typedArrayD.getBoolean(R$styleable.MaterialCheckBox_useMaterialThemeColors, false);
        typedArrayD.recycle();
    }
}
