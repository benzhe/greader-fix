...
public class MediaSessionCompat {
    ...
    public static abstract class Callback {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending((we) message.obj);
                }
            }
        }
        ...
        public void handleMediaPlayPauseKeySingleTapIfPending(we weVar) {
            if (this.mMediaPlayPauseKeyPending) {
                ...
                mediaSessionImpl.setCurrentControllerInfo(weVar);
                if (z && z3) {
                    onPause();
                } else if (!z && z2) {
                    onPlay();
        ...
        public boolean onMediaButtonEvent(Intent intent) {
            ...
            we currentControllerInfo = mediaSessionImpl.getCurrentControllerInfo();
    ...
    public interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(we weVar);
        ...
        void setPlaybackToRemote(af afVar);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public int getRccTransportControlFlagsFromActions(long j) {
            ...
            return (j & 256) != 0 ? rccTransportControlFlagsFromActions | RecyclerView.a0.FLAG_TMP_DETACHED : rccTransportControlFlagsFromActions;
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi21 {
        ...
        public final we getCurrentControllerInfo() {
            return new we(((MediaSession) this.mSessionObj).getCurrentControllerInfo());
        }

        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(we weVar) {
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private af.a mVolumeCallback = new af.a() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // af.a
            public void onVolumeChanged(af afVar) {
                if (MediaSessionImplBase.this.mVolumeProvider != afVar) {
                    return;
                }
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    af afVar = mediaSessionImplBase.mVolumeProvider;
                    if (i == 2) {
                        throw null;
                    }
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                if (MediaSessionImplBase.this.mDestroyed) {
                    ...
                    MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new we("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid()));
                }
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new we(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt(MediaSessionCompat.DATA_CALLING_PID), data.getInt(MediaSessionCompat.DATA_CALLING_UID)));
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public we getCurrentControllerInfo() {
            we weVar;
            synchronized (this.mLock) {
                weVar = this.mRemoteUserInfo;
            }
            return weVar;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(af afVar) {
            if (afVar == null) {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            StringBuilder sbZ = jo.z("MediaSession.QueueItem {Description=");
            sbZ.append(this.mDescription);
            sbZ.append(", Id=");
            return jo.r(sbZ, this.mId, " }");
        }
    ...
    public void setPlaybackToRemote(af afVar) {
        ...
        this.mImpl.setPlaybackToRemote(afVar);
    }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new we(callingPackage, Binder.getCallingPid(), Binder.getCallingUid()));
            }
