...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public String toString() {
        ...
        return jo.r(sb, this.mActiveItemId, StringSubstitutor.DEFAULT_VAR_END);
    }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public String toString() {
            StringBuilder sbZ = jo.z("Action:mName='");
            sbZ.append((Object) this.mName);
            sbZ.append(", mIcon=");
            sbZ.append(this.mIcon);
            sbZ.append(", mExtras=");
            sbZ.append(this.mExtras);
            return sbZ.toString();
        }
