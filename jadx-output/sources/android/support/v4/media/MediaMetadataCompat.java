...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final f4<String, Integer> METADATA_KEYS_TYPE;
    ...
    static {
        f4<String, Integer> f4Var = new f4<>();
        METADATA_KEYS_TYPE = f4Var;
        f4Var.put(METADATA_KEY_TITLE, 1);
        f4Var.put(METADATA_KEY_ARTIST, 1);
        f4Var.put(METADATA_KEY_DURATION, 0);
        f4Var.put(METADATA_KEY_ALBUM, 1);
        f4Var.put(METADATA_KEY_AUTHOR, 1);
        f4Var.put(METADATA_KEY_WRITER, 1);
        f4Var.put(METADATA_KEY_COMPOSER, 1);
        f4Var.put(METADATA_KEY_COMPILATION, 1);
        f4Var.put(METADATA_KEY_DATE, 1);
        f4Var.put(METADATA_KEY_YEAR, 0);
        f4Var.put(METADATA_KEY_GENRE, 1);
        f4Var.put(METADATA_KEY_TRACK_NUMBER, 0);
        f4Var.put(METADATA_KEY_NUM_TRACKS, 0);
        f4Var.put(METADATA_KEY_DISC_NUMBER, 0);
        f4Var.put(METADATA_KEY_ALBUM_ARTIST, 1);
        f4Var.put(METADATA_KEY_ART, 2);
        f4Var.put(METADATA_KEY_ART_URI, 1);
        f4Var.put(METADATA_KEY_ALBUM_ART, 2);
        f4Var.put(METADATA_KEY_ALBUM_ART_URI, 1);
        f4Var.put(METADATA_KEY_USER_RATING, 3);
        f4Var.put(METADATA_KEY_RATING, 3);
        f4Var.put(METADATA_KEY_DISPLAY_TITLE, 1);
        f4Var.put(METADATA_KEY_DISPLAY_SUBTITLE, 1);
        f4Var.put(METADATA_KEY_DISPLAY_DESCRIPTION, 1);
        f4Var.put(METADATA_KEY_DISPLAY_ICON, 2);
        f4Var.put(METADATA_KEY_DISPLAY_ICON_URI, 1);
        f4Var.put(METADATA_KEY_MEDIA_ID, 1);
        f4Var.put(METADATA_KEY_BT_FOLDER_TYPE, 0);
        f4Var.put(METADATA_KEY_MEDIA_URI, 1);
        f4Var.put(METADATA_KEY_ADVERTISEMENT, 0);
        f4Var.put(METADATA_KEY_DOWNLOAD_STATUS, 0);
    ...
    public static final class Builder {
        ...
        public Builder putBitmap(String str, Bitmap bitmap) {
            f4<String, Integer> f4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if ((f4Var.e(str) >= 0) && f4Var.getOrDefault(str, null).intValue() != 2) {
                throw new IllegalArgumentException(jo.o("The ", str, " key cannot be used to put a Bitmap"));
            }
        ...
        public Builder putLong(String str, long j) {
            f4<String, Integer> f4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if ((f4Var.e(str) >= 0) && f4Var.getOrDefault(str, null).intValue() != 0) {
                throw new IllegalArgumentException(jo.o("The ", str, " key cannot be used to put a long"));
            }
        ...
        public Builder putRating(String str, RatingCompat ratingCompat) {
            f4<String, Integer> f4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if ((f4Var.e(str) >= 0) && f4Var.getOrDefault(str, null).intValue() != 3) {
                throw new IllegalArgumentException(jo.o("The ", str, " key cannot be used to put a Rating"));
            }
        ...
        public Builder putString(String str, String str2) {
            f4<String, Integer> f4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if ((f4Var.e(str) >= 0) && f4Var.getOrDefault(str, null).intValue() != 1) {
                throw new IllegalArgumentException(jo.o("The ", str, " key cannot be used to put a String"));
            }
        ...
        public Builder putText(String str, CharSequence charSequence) {
            f4<String, Integer> f4Var = MediaMetadataCompat.METADATA_KEYS_TYPE;
            if ((f4Var.e(str) >= 0) && f4Var.getOrDefault(str, null).intValue() != 1) {
                throw new IllegalArgumentException(jo.o("The ", str, " key cannot be used to put a CharSequence"));
            }
