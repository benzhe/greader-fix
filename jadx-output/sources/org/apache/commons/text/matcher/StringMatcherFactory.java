...
public final class StringMatcherFactory {
    ...
    public StringMatcher andMatcher(StringMatcher... stringMatcherArr) {
        ...
        return length == 0 ? NONE_MATCHER : length == 1 ? stringMatcherArr[0] : new AbstractStringMatcher.AndStringMatcher(stringMatcherArr);
    }
    ...
    public StringMatcher charSetMatcher(char... cArr) {
        ...
        return length == 0 ? NONE_MATCHER : length == 1 ? new AbstractStringMatcher.CharMatcher(cArr[0]) : new AbstractStringMatcher.CharSetMatcher(cArr);
    }
