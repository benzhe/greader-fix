...
public class IOUtils {
    ...
    public static int read(Reader reader, char[] cArr, int i, int i2) throws IOException {
        if (i2 < 0) {
            throw new IllegalArgumentException(jo.g("Length must not be negative: ", i2));
        }
        int i3 = i2;
        while (i3 > 0) {
    ...
    public static void readFully(Reader reader, char[] cArr, int i, int i2) throws IOException {
        ...
        if (i3 != i2) {
            throw new EOFException(jo.i("Length to read: ", i2, " actual: ", i3));
        }
    }
    ...
    public static long skip(InputStream inputStream, long j) throws IOException {
        if (j < 0) {
            throw new IllegalArgumentException(jo.j("Skip count must be non-negative, actual: ", j));
        }
    ...
    public static void skipFully(InputStream inputStream, long j) throws IOException {
        if (j < 0) {
            throw new IllegalArgumentException(jo.j("Bytes to skip must not be negative: ", j));
        }
    ...
    public static URL resourceToURL(String str, ClassLoader classLoader) throws IOException {
        ...
        throw new IOException(jo.n("Resource not found: ", str));
    }
    ...
    public static byte[] toByteArray(InputStream inputStream, long j) throws IOException {
        ...
        throw new IllegalArgumentException(jo.j("Size cannot be greater than Integer max value: ", j));
    }
    ...
    public static void readFully(ReadableByteChannel readableByteChannel, ByteBuffer byteBuffer) throws IOException {
        ...
        if (i != iRemaining) {
            throw new EOFException(jo.i("Length to read: ", iRemaining, " actual: ", i));
        }
    }

    public static byte[] toByteArray(InputStream inputStream, int i) throws IOException {
        if (i < 0) {
            throw new IllegalArgumentException(jo.g("Size must be equal or greater than zero: ", i));
        }
        int i2 = 0;
        if (i == 0) {
            return new byte[0];
        ...
        throw new IOException(jo.i("Unexpected read size. current: ", i2, ", expected: ", i));
    }
