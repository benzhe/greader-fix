...
public class EndianUtils {
    ...
    public static int swapInteger(int i) {
        return (((i >> 0) & Base64.BASELENGTH) << 24) + (((i >> 8) & Base64.BASELENGTH) << 16) + (((i >> 16) & Base64.BASELENGTH) << 8) + (((i >> 24) & Base64.BASELENGTH) << 0);
    }
    ...
    public static short swapShort(short s) {
        return (short) ((((s >> 0) & Base64.BASELENGTH) << 8) + (((s >> 8) & Base64.BASELENGTH) << 0));
    }
    ...
    public static void writeSwappedInteger(byte[] bArr, int i, int i2) {
        bArr[i + 0] = (byte) ((i2 >> 0) & Base64.BASELENGTH);
        bArr[i + 1] = (byte) ((i2 >> 8) & Base64.BASELENGTH);
        bArr[i + 2] = (byte) ((i2 >> 16) & Base64.BASELENGTH);
        bArr[i + 3] = (byte) ((i2 >> 24) & Base64.BASELENGTH);
    }
    ...
    public static void writeSwappedShort(byte[] bArr, int i, short s) {
        bArr[i + 0] = (byte) ((s >> 0) & Base64.BASELENGTH);
        bArr[i + 1] = (byte) ((s >> 8) & Base64.BASELENGTH);
    }
    ...
    public static int readSwappedInteger(InputStream inputStream) throws IOException {
        return ((read(inputStream) & Base64.BASELENGTH) << 0) + ((read(inputStream) & Base64.BASELENGTH) << 8) + ((read(inputStream) & Base64.BASELENGTH) << 16) + ((read(inputStream) & Base64.BASELENGTH) << 24);
    }

    public static short readSwappedShort(InputStream inputStream) throws IOException {
        return (short) (((read(inputStream) & Base64.BASELENGTH) << 0) + ((read(inputStream) & Base64.BASELENGTH) << 8));
    }

    public static int readSwappedUnsignedShort(InputStream inputStream) throws IOException {
        return ((read(inputStream) & Base64.BASELENGTH) << 0) + ((read(inputStream) & Base64.BASELENGTH) << 8);
    }
    ...
    public static long readSwappedUnsignedInteger(InputStream inputStream) throws IOException {
        ...
        int i2 = read(inputStream);
        int i3 = read(inputStream);
        return ((read(inputStream) & Base64.BASELENGTH) << 24) + ((((i & Base64.BASELENGTH) << 0) + ((i2 & Base64.BASELENGTH) << 8) + ((i3 & Base64.BASELENGTH) << 16)) & 4294967295L);
    }

    public static void writeSwappedShort(OutputStream outputStream, short s) throws IOException {
        outputStream.write((byte) ((s >> 0) & Base64.BASELENGTH));
        outputStream.write((byte) ((s >> 8) & Base64.BASELENGTH));
    }

    public static void writeSwappedInteger(OutputStream outputStream, int i) throws IOException {
        outputStream.write((byte) ((i >> 0) & Base64.BASELENGTH));
        outputStream.write((byte) ((i >> 8) & Base64.BASELENGTH));
        outputStream.write((byte) ((i >> 16) & Base64.BASELENGTH));
        outputStream.write((byte) ((i >> 24) & Base64.BASELENGTH));
    }
