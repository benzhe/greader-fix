...
public class XmlStreamReader extends Reader {
    ...
    private String doLenientDetection(String str, XmlStreamReaderException xmlStreamReaderException) throws IOException {
        if (str != null && str.startsWith("text/html")) {
            try {
                return calculateHttpEncoding(jo.n("text/xml", str.substring(9)), xmlStreamReaderException.getBomEncoding(), xmlStreamReaderException.getXmlGuessEncoding(), xmlStreamReaderException.getXmlEncoding(), true);
            } catch (XmlStreamReaderException e) {
    ...
    private static String getXmlProlog(InputStream inputStream, String str) throws IOException {
        if (str != null) {
            ...
            if (iIndexOf == -1) {
                ...
                throw new IOException(jo.h("XML prolog or ROOT element not found on first ", i2, " bytes"));
            }
            if (i2 > 0) {
                inputStream.reset();
