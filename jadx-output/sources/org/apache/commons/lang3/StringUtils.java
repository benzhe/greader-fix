...
public class StringUtils {
    ...
    private static String appendIfMissing(String str, CharSequence charSequence, boolean z, CharSequence... charSequenceArr) {
        ...
        sbZ.append(charSequence.toString());
        return sbZ.toString();
    }
    ...
    public static double getJaroWinklerDistance(CharSequence charSequence, CharSequence charSequence2) {
        ...
        double length = (((d - r0[1]) / d) + ((d / charSequence2.length()) + (d / charSequence.length()))) / 3.0d;
        if (length >= 0.7d) {
    ...
    */
    ...
    public static String join(byte[] bArr, char c, int i, int i2) {
        ...
        sbNewStringBuilder.append((int) bArr[i]);
        while (true) {
            i++;
            if (i >= i2) {
    ...
    private static String replaceEach(String str, String[] strArr, String[] strArr2, boolean z, int i) {
        ...
        if (length2 != length3) {
            throw new IllegalArgumentException(jo.i("Search and Replace array lengths don't match: ", length2, " vs ", length3));
        }
        ...
        if (i2 >= i3) {
            ...
            if (i2 >= i4) {
                if ((i2 + i) - length < str.length()) {
                    StringBuilder sbZ = jo.z(str2);
                    sbZ.append(abbreviate(str.substring(i), str2, i5));
                    return sbZ.toString();
                }
                StringBuilder sbZ2 = jo.z(str2);
                sbZ2.append(str.substring(str.length() - i5));
    ...
    public static String join(char[] cArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        sbNewStringBuilder.append(cArr[i]);
        while (true) {
            i++;
            if (i < i2) {
                sbNewStringBuilder.append(c);
    ...
    public static String join(double[] dArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        sbNewStringBuilder.append(dArr[i]);
        while (true) {
            i++;
            if (i < i2) {
                sbNewStringBuilder.append(c);
    ...
    public static String join(float[] fArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        sbNewStringBuilder.append(fArr[i]);
        while (true) {
            i++;
            if (i < i2) {
                sbNewStringBuilder.append(c);
    ...
    public static String join(int[] iArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        sbNewStringBuilder.append(iArr[i]);
        while (true) {
            i++;
            if (i < i2) {
                sbNewStringBuilder.append(c);
    ...
    public static String join(long[] jArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        sbNewStringBuilder.append(jArr[i]);
        while (true) {
            i++;
            if (i < i2) {
                sbNewStringBuilder.append(c);
    ...
    public static String join(Object[] objArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        if (objArr[i] != null) {
            sbNewStringBuilder.append(objArr[i]);
        }
        while (true) {
            i++;
            if (i < i2) {
    ...
    public static String join(short[] sArr, char c, int i, int i2) {
        ...
        StringBuilder sbNewStringBuilder = newStringBuilder(i3);
        sbNewStringBuilder.append((int) sArr[i]);
        while (true) {
            i++;
            if (i < i2) {
                sbNewStringBuilder.append(c);
