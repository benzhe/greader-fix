...
public class x2 {
    ...
    public static int b(Context context, int i) {
        ...
        return d8.h(c(context, i), Math.round(Color.alpha(r4) * f2));
    }
    ...
    public static ColorStateList d(Context context, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, iArr);
        try {
            if (!typedArrayObtainStyledAttributes.hasValue(0) || (resourceId = typedArrayObtainStyledAttributes.getResourceId(0, 0)) == 0 || (colorStateList = p0.a(context, resourceId)) == null) {
