...
public final class eg7<T> extends hb7 {
    public final vb7<T> a;
    public final uc7<? super T, ? extends lb7> b;

    public static final class a<T> extends AtomicReference<ic7> implements tb7<T>, jb7, ic7 {
        public final jb7 e;
    ...
    public eg7(vb7<T> vb7Var, uc7<? super T, ? extends lb7> uc7Var) {
        this.a = vb7Var;
        this.b = uc7Var;
    }
