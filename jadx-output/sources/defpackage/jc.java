...
public class jc extends nc {
    ...
    public class b implements Transition.TransitionListener {
        ...
        public b(jc jcVar, View view, ArrayList arrayList) {
            this.a = view;
            this.b = arrayList;
        }
    ...
    public class c implements Transition.TransitionListener {
        ...
        public void onTransitionStart(Transition transition) {
            Object obj = this.a;
            if (obj != null) {
                jc.this.o(obj, this.b, null);
            }
            Object obj2 = this.c;
            if (obj2 != null) {
                jc.this.o(obj2, this.d, null);
            }
            Object obj3 = this.e;
            if (obj3 != null) {
                jc.this.o(obj3, this.f, null);
            }
        }
    }
    ...
    public static boolean w(Transition transition) {
        return (nc.k(transition.getTargetIds()) && nc.k(transition.getTargetNames()) && nc.k(transition.getTargetTypes())) ? false : true;
    }
    ...
    public void b(Object obj, ArrayList<View> arrayList) {
        ...
        if (w(transition) || !nc.k(transition.getTargets())) {
            return;
        }
