...
public final class n84 extends u74<Double> implements RandomAccess, i94, ja4 {
    public static final n84 h;
    public double[] f;
    public int g;

    static {
        n84 n84Var = new n84(new double[0], 0);
        h = n84Var;
        n84Var.e = false;
    }
    ...
    public final boolean addAll(Collection<? extends Double> collection) {
        ...
        if (!(collection instanceof n84)) {
            return super.addAll(collection);
        }
        n84 n84Var = (n84) collection;
        int i = n84Var.g;
        if (i == 0) {
            return false;
        }
        ...
        System.arraycopy(n84Var.f, 0, this.f, this.g, n84Var.g);
        this.g = i3;
        ((AbstractList) this).modCount++;
        return true;
    }
    ...
    public final int hashCode() {
        int iA = 1;
        for (int i = 0; i < this.g; i++) {
            iA = (iA * 31) + j94.a(Double.doubleToLongBits(this.f[i]));
        }
        return iA;
    }
    ...
    public final /* bridge */ /* synthetic */ i94 w(int i) {
        if (i >= this.g) {
            return new n84(Arrays.copyOf(this.f, i), this.g);
        }
        throw new IllegalArgumentException();
    }

    public n84(double[] dArr, int i) {
        this.f = dArr;
        this.g = i;
    }
}
