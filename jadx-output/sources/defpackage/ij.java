...
public enum ij implements gj {
    ...
    public static class a {
        public static final Set<String> a = new HashSet(Arrays.asList(kj.a.a()));
    }
    ...
    public boolean isSupported() {
        int i = this.g;
        return (i != -1 && Build.VERSION.SDK_INT >= i) || k();
    }
    ...
    ij(String str, String str2, int i) {
        this.e = str;
        this.f = str2;
        this.g = i;
    }
