...
public final class nb4 extends mb4 {
            ...
            if (c50.v2(b2)) {
                ...
                if (!(b2 < -32)) {
                    if (b2 < -16) {
                        ...
                        int i7 = i5 + 1;
                        c50.P3(b2, bArr[i5], bArr[i7], cArr, i4);
                        i = i7 + 1;
                        i4++;
                    } else {
                        if (i5 >= i3 - 2) {
                        ...
                        int i8 = i5 + 1;
                        int i9 = i8 + 1;
                        c50.X3(b2, bArr[i5], bArr[i8], bArr[i9], cArr, i4);
                        i4 += 2;
                        i = i9 + 1;
                    }
                } else {
