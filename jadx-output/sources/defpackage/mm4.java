...
public final class mm4<E> extends qj4<E> implements RandomAccess {
    public static final mm4<Object> h;
    public E[] f;
    public int g;

    static {
        mm4<Object> mm4Var = new mm4<>(new Object[0], 0);
        h = mm4Var;
        mm4Var.e = false;
    }

    public mm4(E[] eArr, int i) {
        this.f = eArr;
        this.g = i;
    }
    ...
    public final /* synthetic */ wk4 i(int i) {
        if (i >= this.g) {
            return new mm4(Arrays.copyOf(this.f, i), this.g);
        }
