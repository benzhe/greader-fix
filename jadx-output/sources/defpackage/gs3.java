...
public final class gs3 extends ms3<it3> {
    ...
    public gs3(wr3 wr3Var, Context context, zzvt zzvtVar, String str, hg0 hg0Var) {
        this.f = wr3Var;
        this.b = context;
        this.c = zzvtVar;
        this.d = str;
    ...
    public final it3 a(qt3 qt3Var) throws RemoteException {
        return qt3Var.zzb(new y20(this.b), this.c, this.d, this.e, 204890000);
    }

    @Override // defpackage.ms3
    public final /* synthetic */ it3 c() {
        wr3.d(this.b, "interstitial");
        return new t30();
    }
